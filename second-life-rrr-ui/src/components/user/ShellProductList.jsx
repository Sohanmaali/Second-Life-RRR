...
//   const [filter, setFilter] = useState("All products"); // State for filter selection
...
//   const totalPages = Math.ceil(scrapProductDetails.length / itemsPerPage);
...
//     } else if (filter === "Rejected Product") {
//       return product.status === "REJECT"; // Show rejected products
//     } else if (filter === "Shell Product") {
//       return product.category === "shell"; // Adjust based on your actual category field
//     } else {
//       return true; // Default to show all if no specific filter matches
//     }
//   });
