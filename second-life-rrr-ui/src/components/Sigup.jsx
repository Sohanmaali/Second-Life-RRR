...
export default function Sigup() {
  ...
  useEffect(() => {
    if (registrationSuccess) {
      navigate("/login");
      // dispatch(resetRegistrationSuccess()); // Reset registration success state
    }
        ...
        <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
            ...
            <div className="mt-3 flex flex-col items-center">
              <div className="my-4 border-b text-center">
                ...
                <div className="mx-auto max-w-xs">
                  <form onSubmit={SigupDataHendlor} method="post">
                    <input
          ...
          <div className="flex-1 bg-green-100 text-center hidden lg:flex">
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://rukminim2.flixcart.com/image/850/1000/xif0q/poster/g/h/y/medium-god-budhha-art-posters-gautam-buddha-hd-god-photo-original-imagp4btfeburhun.jpeg?q=90&crop=false')",
              }}
            ></div>
          </div>
        </div>
